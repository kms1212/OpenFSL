...
error_t openfsl::fat32::FAT32::makeFile(const std::string filename) {
...
error_t openfsl::fat32::FAT32::move(const std::string from, const std::string to) {
    // Separate path and file name
...
error_t openfsl::fat32::FAT32::search(
...
error_t openfsl::fat32::FAT32::removeFile(const std::string dirname) {
