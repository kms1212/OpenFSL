...
error_t openfsl::fat32::FAT32::__forEachEntry(
        ...
        if (fileEntry->fileName[0] == 0x00) {
            ...
            if (fileEntry->fileAttr == FileAttribute::LFN) {
                ...
                if (copySize) {
                    ...
                    filenamebuf << ucs2ToU8(nametmpseq);
                ...
                fileInfo.fileCreateTime = __toFslTime(fileEntry->fileCreateTime,
                                                      fileEntry->fileCreateDate);

                fileInfo.fileModTime = __toFslTime(fileEntry->fileModTime,
                                                   fileEntry->fileModDate);

                fileInfo.fileAccessTime = __toFslTime(fileEntry->fileAccessDate);
